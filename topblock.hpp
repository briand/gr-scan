...
class TopBlock : public gr::top_block
{
	public:
		TopBlock(double centre_freq_1, double centre_freq_2, double sample_rate, double fft_width, double bandwidth1, double bandwidth2,
				double step, unsigned int avg_size, double spread, double threshold, double ptime) : top_block("Top Block"),
			...
			lg(gr::blocks::nlog10_ff::make(10, vector_length, -20 * log10(vector_length) -10 * log10(GetWindowPower()/vector_length))),
